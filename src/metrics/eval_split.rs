...
impl SplitEvaluator {
    ...
    pub fn on_split(facet: &Facet, evaluator: &Evaluator, split: &DataSplits, split_name: &str) -> EvalSummary {
    ...
    pub fn full_pipeline(
        ...
        let train_eval = Self::on_split(facet, evaluator, splits, "train");
        let val_eval = Self::on_split(facet, evaluator, splits, "validation");
        let test_eval = Self::on_split(facet, evaluator, splits, "test");
