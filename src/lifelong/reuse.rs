...
pub fn extract_features(facet: &Facet) -> Vec<FeatureSet> {
...
pub fn apply_features(facet: &mut Facet, features: &[FeatureSet]) {
    for fs in features {
...
pub fn feature_similarity(a: &FeatureSet, b: &FeatureSet) -> f64 {
